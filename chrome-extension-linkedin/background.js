...
chrome.runtime.onMessage.addListener((request, sender, sendResponse) => {
  ...
  if (request.action === 'openPopup') {
    ...
    console.log('[SF Background] Profile data from button:', request.profileData);
...
async function handleCreateCandidateWithContact(data) {
  ...
  const { firstName, lastName, email, phone, birthday, linkedinUrl, agency, position, status, nextStep } = data;

  console.log('[SF Import] Destructured values - email:', email, 'phone:', phone, 'birthday:', birthday);
  console.log('[SF Import] Creating contact with:', { firstName, lastName, email, phone, birthday, linkedinUrl });
