...
2. Flow checked if the assigned Contact (Pat Baker) is a Service User → YES (found in Service_User\_\_mdt)
...
7. **Salesforce returned Brian Darzev's Contact as first result** (he has null/blank Personal_Email\_\_c)
...
- Brian Darzev has no Personal_Email\_\_c value (null)
...
- Personal_Email\_\_c: null
- Email: null
- Status: Inactive employee

## Recommendations

1. Consider adding validation to ensure Personal_Email\_\_c is not blank when queried in flows
2. Review all flows using Personal_Email\_\_c to ensure they handle null/empty values correctly
3. Consider updating Brian Darzev's Contact to inactive status or add a Personal_Email\_\_c value to prevent future matches
