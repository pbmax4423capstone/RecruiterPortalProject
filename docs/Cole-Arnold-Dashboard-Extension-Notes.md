...
- **Data Integrity:** Leadership requested that all dashboard KPIs align with _completed_ interviews only. Prior queries mixed in scheduled/ongoing interviews, which inflated counts.
...
- Documented the candidate creation order (Contact -> Candidate\_\_c) and kept guard IIFE wrapper intact.
