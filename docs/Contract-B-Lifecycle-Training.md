...
|-----------|--------|---------|
| Calculate_Contract_End_Date | Candidate__c | Before Save |
| Process_Contract_Extension | Candidate__c | Before Save |
| Track_Contract_B_Transition | Candidate__c | Before Save |
...
Ensure users have access to these fields on Candidate__c:
