...
1. ✅ Monitor your Contract B agents' progress daily
2. ✅ Track FYC and submission counts
3. ✅ Identify at-risk agents early
4. ✅ Recommend extensions when appropriate
5. ✅ Support agents in meeting requirements
...
4. Save (adds 4 months automatically)
...
```
Day 60: No progress → Alert Recruiting Manager
Day 90: Still behind → Extension discussion with Director
Day 105: Critical status → Final decision meeting
Day 120: Deadline → Transition or Termination
```
...
To view Contract B agent details:

1. **Dashboard View:** Contract B Pipeline → Find agent in table
