...
mockMetrics = [
    ...
    { label: 'Interview Rate', value: 85, variant: 'summary-rate', isPercentage: true }
];
```
...
```css
.summary-total { background: linear-gradient(135deg, #0176d3, #032d60); }
.summary-warning { background: linear-gradient(135deg, #f39c12, #b37209); }
.summary-info { background: linear-gradient(135deg, #06a59a, #014d48); }
.summary-purple { background: linear-gradient(135deg, #9b59b6, #6c3483); }
.summary-success { background: linear-gradient(135deg, #2e844a, #194e2e); }
.summary-rate { background: linear-gradient(135deg, #0176d3, #9b59b6); }
```
