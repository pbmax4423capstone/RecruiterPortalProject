...
const CONFIG = {
  ...
  clientId:
    "3MVG9AR068fT4usyVQdDlbJ3XVwtPbfdsuFVEcup3mEwR.dQlnrkDltgNCeCXb6bRrC.uTfLjhvHaFkrn7bWd", // ProdTest Consumer Key
...
function initializeElements() {
  ...
  if (createAnywayBtn)
    createAnywayBtn.addEventListener("click", handleCreateAnyway);
...
async function handleCheckDuplicates() {
  ...
  checkDuplicatesBtn.innerHTML =
    '<span class="loading"><span class="spinner"></span> Checking...</span>';
...
async function createCandidate() {
  ...
  try {
    ...
    if (
      ...
      showStatus(
        "Session expired. Please disconnect then reconnect to Salesforce.",
        "error"
      );
