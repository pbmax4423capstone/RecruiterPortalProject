...
- All `InterviewLeaderboard*` Apex methods must continue filtering on **completed** interviews (Status = Completed and Date_Completed\_\_c within the requested window).
...
2. Then creates Candidate**c linked to Contact via Contact**c field
3. Uses Type\_\_c: 'Candidate'
