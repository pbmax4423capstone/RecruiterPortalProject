# Business Page to Salesforce Extension (Chrome)

## Overview

This Google Chrome extension allows recruiters to import candidates from **any business page** into Salesforce with built-in duplicate detection.
...
4. Select the `chrome-extension-business-page` folder
