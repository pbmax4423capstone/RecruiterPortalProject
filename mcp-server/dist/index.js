...
class RecruitingMCPServer {
    ...
    async ensureSalesforceConnection() {
    ...
    async updateInterviewOutcome(args) {
    ...
    async getRecruiterDashboardData(args) {
    ...
    async rescheduleInterview(args) {
